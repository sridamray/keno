...
!(function (e, t) {
                ...
                for (var d, p = i.split(" "), c = 0; c < this.length; c += 1) {
                    ...
                    if (s)
                        for (d = 0; d < p.length; d += 1) {
                            var h = p[d];
                            u.dom7LiveListeners || (u.dom7LiveListeners = {}), u.dom7LiveListeners[h] || (u.dom7LiveListeners[h] = []), u.dom7LiveListeners[h].push({ listener: r, proxyListener: l }), u.addEventListener(h, l, n);
                        }
                    else
                        for (d = 0; d < p.length; d += 1) {
                            var v = p[d];
    ...
    function A(e) {
        ...
        if ((o.originalEvent && (o = o.originalEvent), i.isTouched)) {
            if (!i.isTouchEvent || "touchmove" === o.type) {
                ...
                if (!a.allowTouchMove) return (a.allowClick = !1), void (i.isTouched && (S(n, { startX: p, startY: c, currentX: p, currentY: c }), (i.touchStartTime = x())));
        ...
        if (((a.isTouched = !1), (a.isMoved = !1), (a.startMoving = !1), (p = i.followFinger ? (r ? t.translate : -t.translate) : -a.currentTranslate), !i.cssMode))
            if (i.freeMode) {
                ...
                if (i.freeModeMomentum) {
                    ...
                    if (w < t.maxTranslate())
                        i.freeModeMomentumBounce ? (w + t.maxTranslate() < -S && (w = t.maxTranslate() - S), (y = t.maxTranslate()), (C = !0), (a.allowMomentumBounce = !0)) : (w = t.maxTranslate()), i.loop && i.centeredSlides && (T = !0);
                    else if (w > t.minTranslate())
                        i.freeModeMomentumBounce ? (w - t.minTranslate() > S && (w = t.minTranslate() + S), (y = t.minTranslate()), (C = !0), (a.allowMomentumBounce = !0)) : (w = t.minTranslate()), i.loop && i.centeredSlides && (T = !0);
                ...
                updateSlides: function () {
                    ...
                    if (void 0 !== n) {
                        ...
                        "string" == typeof E && E.indexOf("%") >= 0 && (E = (parseFloat(E.replace("%", "")) / 100) * n),
                            ...
                            s.slidesPerColumn > 1 &&
                                ((M = Math.floor(h / s.slidesPerColumn) === h / e.params.slidesPerColumn ? h : Math.ceil(h / s.slidesPerColumn) * s.slidesPerColumn),
                        ...
                        for (var P, k, L, $ = s.slidesPerColumn, I = M / $, O = Math.floor(h / s.slidesPerColumn), A = 0; A < h; A += 1) {
                            ...
                            if (s.slidesPerColumn > 1) {
                                ...
                                if ("row" === s.slidesPerColumnFill && s.slidesPerGroup > 1) {
                                    ...
                                    (N = (G = X - (B = Math.floor(X / Y)) * Y + H * s.slidesPerGroup) + (B * M) / $), D.css({ "-webkit-box-ordinal-group": N, "-moz-box-ordinal-group": N, "-ms-flex-order": N, "-webkit-order": N, order: N });
                                ...
                                u[A] && (u[A].swiperSlideSize = z),
                                    ...
                                    s.centeredSlides
                                        ? ((x = x + z / 2 + T / 2 + E),
                                          ...
                                          f.push(x))
                                        : (s.roundLengths && (x = Math.floor(x)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && v.push(x), f.push(x), (x = x + z + E)),
                                    (e.virtualSize += z + E),
                                    (T = z),
                                    (C += 1);
                            }
                        }
                        if (((e.virtualSize = Math.max(e.virtualSize, n) + b), o && d && ("slide" === s.effect || "coverflow" === s.effect) && r.css({ width: e.virtualSize + s.spaceBetween + "px" }), s.setWrapperSize))
    ...
    var F = {
            update: function (e) {
                ...
                if ((S(t.virtual, { from: y, to: E, offset: x, slidesGrid: t.slidesGrid }), p === y && c === E && !e)) return t.slidesGrid !== h && x !== f && t.slides.css(m, x + "px"), void t.updateProgress();
