...
function keno_scripts() {
	wp_enqueue_style( 'keno-fonts', keno_fonts_url(), array(), null);
	// theme CSS
	wp_enqueue_style( 'dashicons' );
	wp_enqueue_style( 'keno-bootstrap', get_template_directory_uri().'/assets/css/bootstrap.css', array() );
	wp_enqueue_style( 'keno-font-awesome', get_template_directory_uri().'/assets/css/font-awesome-pro.css', array() );
